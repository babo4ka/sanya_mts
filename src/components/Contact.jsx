...
const Contact = () =>{
    ...
    return(
        <div className="contacts_info_holder mt-5 container">
            ...
            <h5 className="col-12  text-center agent_info_little">{config.contacts.agent}</h5>
                ...
                <div className="col-md text-start about_info_holder">
                    <h5 className="col-12  text-center agent_info_large">{config.contacts.agent}</h5>
                    <div>
                    ...
                    <div className="col-12">
                        <span  id="phone_holder">{config.contacts.phone}</span>
